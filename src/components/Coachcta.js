    ...
    <>
      ...
      <div className="coach_cta w-full relative bg-[url('/background_new.jpg')] bg-no-repeat bg-center overflow-hidden">
        <div className="container mx-auto 2xl:py-20 xl:py-20 lg:py-20 md:py-20 sm:py-14 kx:py-12 km:py-10">
          <div className="flex items-center justify-center h-48">
            <div className="cta_text text-center">
              <h2 className="font-semibold 2xl:text-3xl xl:text-3xl lg:text-3xl md:text-3xl sm:text-2xl kx:text-base km:text-base py-3 text-white 2xl:w-[80%] xl:w-[80%] lg:w-[80%] md:w-[80%] sm:w-[80%] kx:w-[100%] km:w-[100%] mx-auto">
                {
                  getPotentialCoachData?.acf?.potential_as_a_coach?.text_section
                    ?.title_1
                }
                {
                  getPotentialCoachData?.acf?.potential_as_a_coach?.text_section
              ...
              <button className="bg-[#FF8B00] hover:bg-yellow-700 text-white py-3 font-medium px-6 rounded-full mt-4 text-base sm:text-sm kx:text-sm km:text-sm hover:text-white transform transition-all duration-500 ease-in-out hover:scale-110 hover:brightness-110 hover:animate-pulse active:animate-bounce">
                {
                  getPotentialCoachData?.acf?.potential_as_a_coach?.text_section
                    ?.button_section?.button_text
                }
              </button>
            </div>
          </div>
