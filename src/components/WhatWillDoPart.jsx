    ...
    <>
      <div className="wile_do_part bg-[#fff] 2xl:py-24 xl:py-24 lg:py-24 md:py-24 sm:py-20 kx:py-0 km:py-0">
        <div className="container wile_padding md:w-[100%] sm:w-[100vw] mx-auto px-14 2xl:px-14 xl:px-10 lg:px-4 md:px-2 sm:px-2 kx:px-0 km:px-0">
          <div className="2xl:flex xl:flex lg:flex md:block sm:block items-center  justify-center gap-20 my-5">
            <div className=" img 2xl:w-2/4 xl:w-2/4 lg:w-2/4 md:w-2/3 sm:w-3/4  sm:m-auto flex justify-center ">
              <div className="img_inner_relative relative">
                <div className=" absolute w-[450px] h-30 bg-[#FF8B00] -top-7 bottom-6 -right-8 -z-0 rounded-xl "></div>
                <img
                  className=" relative  w-[450px] h-30  object-cover rounded-xl z-10 flex "
                  src={
                    whaticandoData?.acf?.what_i_do_options?.image_section?.image
                  }
                />
              ...
              {whaticandoData?.acf?.what_i_do_options?.text_section?.texts?.map(
                (data, index) => (
                  <ul key={data?.id || index}>
                    <li className="flex justify-start items-start gap-3 mb-2">
          ...
          <div className="background-box my-10 2xl:flex xl:flex lg:flex md:flex sm:flex kx:flex km:flex flex-wrap kx:justify-evenly km:justify-evenly gap-5 w-full 2xl:h-auto xl:h-auto lg:h-auto md:h-auto sm:h-auto kx:h-[470px] km:h-[470px] md:justify-center md:gap-10 md:flex-wrap sm:flex-wrap kx:flex-wrap km:flex-wrap sm:justify-center sm:gap-10 kx:gap-10 km:gap-10  justify-between">
            {whaticandoData?.acf?.what_i_do_options?.card_section?.map(
              (items,index) => (
                  ...
                  <div
                    ...
                    key={index}
                  >
                    <div className=" absolute bg-[#FF8B00] bottom-5 -right-4 2xl:w-96 2xl:h-48 lg:h-48 md:h-48 sm:h-48 kx:h-48 km:h-48 xl:h-48 xl:w-80 lg:w-72 md:w-52 sm:w-full z-0 rounded-xl"></div>
                    <div className=" absolute box  bg-white border-[1px] border-[#FF8B00] 2xl:py-6 2xl:px-5 xl:py-6 xl:px-5 lg:py-4 lg:px-4 md:py-4 md:px-4 sm:py-3 sm:px-2 rounded-xl ">
                      <div className="coaching_img_box 2xl:h-36 xl:h-36 lg:h-36 md:h-36 sm:h-36 kx:h-36 km:h-36 justify-center 2xl:p-0 xl:p-0 lg:p-0 md:p-0 sm:p-0 kx:p-4 km:p-3 ">
                        <img
                          src={items?.icon}
                          alt="error"
                          className="h-10 w-10 m-auto"
                        />
                        <h3 className="2xl:text-lg xl:text-lg lg:text-lg md:text-base sm:text-sm kx:text-sm km:text-base font-medium text-gray-900 text-center line-clamp-2 my-2 2xl:line-clamp-none xl:line-clamp-2 lg:line-clamp-2 md:line-clamp-2 sm:line-clamp-2 kx:line-clamp-1 km:line-clamp-1 ">
                          {items?.title}
                        </h3>
                        <p className="font-normal 2xl:text-sm xl:text-sm lg:text-sm md:text-sm sm:text-sm kx:text-sm km:text-sm text-gray-600 text-center line-clamp-2 my-1">
                          {items?.texts}
                        </p>
                      </div>
                    </div>
          ...
          <div className="button_part mx-auto flex justify-center 2xl:pb-0 xl:pb-0 lg:pb-0 md:pb-0 sm:pb-0 kx:pb-8 km:pb-8">
            <button className="bg-[#FF8B00] hover:bg-yellow-700 text-white py-3 font-medium px-6 rounded-full mt-4  hover:text-white transform transition-all duration-500 ease-in-out hover:scale-110 hover:brightness-110 hover:animate-pulse active:animate-bounce">
              {
