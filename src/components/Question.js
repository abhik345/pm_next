  ...
  return (
    <>
      <div className='question_part py-20 bg-[url("/qustion_banner.jpg")]'>
        <div className="2xl:container xl:container lg:container md:w-screen sm:w-screen mx-auto 2xl:flex xl:flex lg:flex md:block md:justify-center sm:block sm:justify-center justify-center items-center gap-10 2xl:px-20 xl:px-20 lg:px-16 md:px-14 sm:px-10 kx:px-10 km:px-10">
          <div className="qustion_text 2xl:w-[50%] xl:w-[50%] lg:w-[50%] md:w-full sm:w-full kx:w-full km:w-full">
            ...
            <div className="button_part mx-auto flex justify-start">
              <button className="bg-[#FF8B00] text-sm hover:bg-yellow-700 text-white py-3 font-medium px-10 rounded-full mt-4  hover:text-white transform transition-all duration-500 ease-in-out hover:scale-110 hover:brightness-110 hover:animate-pulse active:animate-bounce">
                {questionData?.acf?.contact_options?.text_section?.button_text}
              </button>
            </div>
          </div>
