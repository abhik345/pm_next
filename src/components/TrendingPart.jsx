...
const TrendingPart = () => {
  ...
  return (
    <>
      <div className="Tranding_part bg-[#3c3c3c] 2xl:py-14 xl:py-14 lg:py-14 md:py-10 sm:py-10 kx:py-8 km:py-8">
            ...
            <div className="flex items-end 2xl:gap-4 xl:gap-4 lg:gap-4 md:gap-4 sm:gap-12 kx:gap-10 km:gap-10 2xl:flex-nowrap xl:flex-nowrap lg:flex-nowrap md:flex-nowrap sm:flex-wrap kx:flex-wrap km:flex-wrap ">
              <div className="box 2xl:w-[55%] xl:w-[55%] lg:w-[55%] md:w-full sm:w-full kx:w-full km:w-full">
                <div className="text-left py-6">
                  <h2 className="2xl:text-4xl xl:text-4xl lg:text-3xl md:text-2xl sm:text-2xl kx:text-xl km:text-xl font-semibold text-white py-1">
                    {
                    ...
                    getProblemSolutionData?.acf?.problem_solution_framework?.problem_solution?.map(
                      (problem, index) => {
                        ...
                        return (
                          ...
                          <p className=" overflow-hidden 2xl:h-44 xl:h-44 lg:h-44 md:h-44 sm:h-auto kx:h-auto km:h-auto 2xl:text-base xl:text-[14px] lg:text-sm md:text-sm sm:text-sm kx:text-sm km:text-sm line-clamp-6 border-[1px] border-white px-5 py-8 rounded-md text-start text-white ">
                    ...
                    <div className="rounded_text  bg-white p-0 flex rounded-full w-48 h-48 items-center justify-center relative">
                      ...
                      >
                        <path
                          ...
                          fill="none"
                        ></path>
                        <text className="font-medium text-[13px] uppercase fill-[#FF8B00]">
                          <textPath
                            href="#circlePath"
                            startOffset="50%"
                            textAnchor="middle"
                      ...
                      <div className="icon_arrow flex justify-center items-center bg-[#FF8B00] w-32 h-32 rounded-full -rotate-[145deg]">
                        <img
