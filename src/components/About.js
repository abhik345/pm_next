          ...
          {isMobile === true ? (
              ...
              {showMore ? (
                <>
                  <p className="pb-2 text-[15px] font-normal">
                    ...
                    clientele in 18 plus countries & a 100+ member team has been
                    an exciting story just like the evolution of the internet.
                  </p>
                  <p className="pb-2 text-[15px] font-normal">
                    Pramod is also actively engaged as a guest lecturer
                    delivering workshops to students in B schools and colleges.
                  </p>
                </>
              ) : null}
            ...
            <>
              <p className="pb-2 text-[15px] font-normal">
                ...
                and create excellence per se. His career from a two-member start
                up to an established unit with 800 plus clientele in 18 plus
                countries & a 100+ member team has been an exciting story just
                like the evolution of the internet.
              </p>
              <p className="pb-2 text-[15px] font-normal">
