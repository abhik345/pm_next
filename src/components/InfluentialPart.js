  ...
  return (
    <>
     {/* <div className="influential_part w-full overflow-hidden py-16 bg-[#3c3c3c]">
        ...
        <div className="influential_part w-full overflow-hidden 2xl:py-16 xl:py-16 lg:py-16 md:py-16 sm:py-16 kx:py-8 km:py-8 bg-[#3c3c3c]">
          <div className="2xl:container xl:container lg:container md:w-screen sm:w-screen mx-auto ">
            <div className=" text-center py-5">
              <h2 className="text-white 2xl:text-4xl xl:text-4xl lg:text-3xl md:text-3xl sm:text-xl font-semibold py-2 text-center flex justify-center items-center gap-5 w-[100%] mx-auto">
                <div className="  bg-white h-[1.5px] w-24"></div>
            ...
            <div className="button_part mx-auto flex justify-center">
              <button className="bg-[#FF8B00] hover:bg-yellow-700 text-white py-3 font-medium 2xl:text-base xl:text-base lg:text-base md:text-base sm:text-sm kx:text-sm km:text-sm px-6 rounded-full mt-4 mb-2  hover:text-white transform transition-all duration-500 ease-in-out hover:scale-110 hover:brightness-110 hover:animate-pulse active:animate-bounce">
                {coachesData?.acf?.coach?.button_section.button_text}
              </button>
            </div>
          </div>
